      ...
      <div id="${el}-body" class="profile">
         <div id="${el}-readview" class="hidden">
            ...
            <div class="viewcolumn">
               ...
               <div class="header-bar">${msg("label.xmpp")}</div>
               <#if username?? && username?length!=0>
               <div class="row">
                  <span class="fieldlabelright">${msg("label.username")}:</span>
                  <span class="fieldvalue">${username?html}</span>
               </div>
               </#if>
            </div>
         </div>
         ...
         <div id="${el}-editview" class="hidden">
            ...
            <#-- EDIT XMPP INFO -->
            <@markup id="editXmppInfo">
            <div class="header-bar">${msg("label.xmpp")}</div>
            <div class="row">
               <span class="label"><label for="${el}-input-username">${msg("label.username")}:</label></span>
               <span><input type="text" maxlength="256" size="30" id="${el}-input-username" value="" <@immutablefield field="username" /> /></span>
            </div>
            </@markup>
